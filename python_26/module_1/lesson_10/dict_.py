...
# print(myfamily.get("child4").get('name'))
# print(myfamily.get("child2")['name'])
...
#     year = int(user.get("birthDate").split("-")[0])
#     if year >= 2000:
