...
# }
#
# d["todo"] , d["completed"] = d["completed"] , d['todo']
# print(d)
...
# d = {
#   "id": 59,
#   "ti45tle": "Spring10 and summershoes",
#   "price": 20,
#   "qu43antity": 3,
#   "total": 60,
#   "discountPercentage": 8.71,
#   "dis12countedPrice": 55,
#   "thumbnail": "https://cdn.dummyjson.com/product-images/59/thumbnail.jpg"
# }
...
#         q_summ += product.get("quantity")
#     l.append((cart.get("id"),q_summ))
#
#
...
# nums = [-9, 1, 2, 7, -7, 8, 10, -9]
# nums = list(set(nums))
# nums.sort()
# print(nums[1])

# string="32.054,232.111"
...
# s = "Lorem Ipsum is simply dummy text".split()
...
#         if r[i] in r[i+1:] and r[i] not in b:
#             b.append(r[i])
#     return b
#
# kirish = ['a','b','w','a']
