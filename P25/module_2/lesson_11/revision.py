...
# encapsulation (public , private , protected) -  yes
# constructir           - magic , dunder
# __repr__              - yes
# import from           - yes
# path                  - absolyute , relative
# with open(path , 'w') as f:      - file close()
# file open()           - open(path , mode = [w , x , a , r])
# open().close()         - yes
# abstraction           - classlar uchun maket
# self                   - yes
# random.randrange(10)   - tasodifiy sonlar tanlab beradi  : yes
# CRUD                   - Create , Read , Update , Delate
# try / except / else / finally     - yes
# __class__.__name__      - yes
# getter setter         - yes
# object                - yes
# method                - yes
# parent class          - yes
# attribute             - yes
# polymorphism          - yes
# os.cpu_count()        -  yes | process soni chiqazadi
# class                 - yes
# child class            - yes
# dataclass             - yes
# from pathlib import Path - path ni boshqarish imkoniyatini oshiradi
# exception             - yes
# property              - yes
# global                - yes
# raise                 - yes
...
#         values: list[str] = str_data.split('|')
#         return cls(*values)
#
#
# print(Student.from_str("Kamol|25|4"))
...
# user = User(id=1, name="Kamol", username="kamol", password="1")
...
class Comments:
    ...
    def create(self):
        comments.append(self.__dict__)

    def update(self, field, new_value):
        for comment in comments:
            if comment.get("id") == self.id:
                if field == "postId":
                    comment['postId'] = new_value
